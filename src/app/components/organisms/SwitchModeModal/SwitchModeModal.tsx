  ...
  return (
    ...
    >
      <div className="self-start w-full pr-6">
        {data?.map((el) => (
          <button className="flex  items-center justify-start w-full active:bg-MainPurple active:text-white text-MediumGrey pl-6 gap-3 py-[15px] rounded-tr-[100px] rounded-br-[100px]">
